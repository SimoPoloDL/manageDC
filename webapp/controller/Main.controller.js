sap.ui.define([
   ...
   var MainController = BaseController.extend("manageCheckList.controller.Main", {
      ...
      onAfterRendering: function() {
         this.model.setData();
         //this.modelDialogAdd.setData();
      },
      onBeforeRendering: function() {
         var that = this;
         var params = {
            "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/GET_PERMISSION_MANAGECL",
            "OutputParameter": "*"
         };
         ...
         $.ajax({
            ...
            success: function(result) {
               ...
               try {
                  if (jQuery(result).find("PERMISSION").text() === "0") {
                     MessageBox.error("You are not authorized!", {
                        title: "No Permission", // default
                        onClose: function() {
                           that.logOff();
                        }, // default
                        styleClass: "", // default
      ...
      getFinishedItems: function(inputTicket, inputPallet) {
         ...
         var transaction = "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/GET_FINISHED_ITEMS";
      ...
      getCheckListByItemAndTypeInsp: function(sItem, sTypeInsp) {
         ...
         var transaction = "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/GET_DC_PALLET_INSP_BY_ITEM_AND_TYPE_INSP";
            ...
            if (data.Rows) {
               if (data.Rows.length) {
                  ...
                  var params = {
                     ...
                     TYPE_INSP: sTypeInsp,
                     CHECK_EXISTS: "true",
                     "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/GET_DC_PALLET_INSP_BY_ITEM_AND_TYPE_INSP",
                     "OutputParameter": "*"
                  };
                                    ...
                                    onClose: function(sAction) {
                                       if (sAction === "YES") {
                                          ...
                                          var params = {
                                             ITEM: sItem,
                                             TYPE_INSP: sTypeInsp,
                                             "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/CREATE_DC_BY_ITEM_AND_TYPE_INSP",
                                             "OutputParameter": "*"
                                          };
      ...
      deleteChecks: function(inputXML) {
         ...
         var params = {
            ...
            INPUT_XML: inputXML,
            "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/REMOVE_PARAMETER_DC_GROUP",
            "OutputParameter": "*"
         };
               ...
               onClose: function(sAction) {
                  if (sAction === "YES") {
                     ...
                     var params = {
                        ...
                        "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/UPDATE_SEQUENCE_PARAMETER_DC_GROUP",
                        "OutputParameter": "*"
                     };
      ...
      addChecklistCheck: function() {
         ...
         var params = {
            ...
            "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/ADD_PARAMETER_DC_GROUP",
            "OutputParameter": "*",
      ...
      onRowSelectionChange: function(oEvent) {
         try {
            if (this.tabellaChecklists.getContextByIndex(oEvent.getParameter("rowIndex")).getObject().STATUS_ROW_TABLE == "Error") {
               this.tabellaChecklists.removeSelectionInterval(oEvent.getParameter("rowIndex"), oEvent.getParameter("rowIndex"));
               MessageToast.show("This parameter is fixed");
            }
         } catch (err) {}
      },
      ...
      onCopyPress: function() {
         if (!this._oDialogCopy) {
            ...
            //this._oDialogCopy.setModel(this.modelDialogAdd, "modelAdd");
      ...
      copyCheckList: function(sItemCopy, sTypeInspCopy) {
        var that = this;
         ...
         var params = {
            ...
            DC_GROUP_BO: this.getInfoModel().getProperty("/dc_group_bo"),
            "TRANSACTION": "ES/TRANSACTIONS/BRAUN/MANAGECHECKLIST/COPY_DC_BY_ORIGIN_DCGROUPBO_ITEM_AND_TYPE_INSP",
            "OutputParameter": "*"
         };
      ...
      formatterVisibleRowAction: function(sStatusRowTable) {
         return (sStatusRowTable !== "Error");
      },
